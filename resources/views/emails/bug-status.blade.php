            ...
            <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
                ...
                <tr><td style="padding:28px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin:18px 0;border:1px solid #e5e7eb;border-radius:6px;">
                        ...
                        @if ($bug->type === 'maintenance' && $bug->prochaine_echeance)
                        <tr><td style="padding:12px 16px;font-size:13px;color:#6b7280;border-top:1px solid #f3f4f6;">Prochaine échéance</td>
                            <td style="padding:12px 16px;font-size:14px;text-align:right;border-top:1px solid #f3f4f6;">{{ $bug->prochaine_echeance->format('d/m/Y') }}</td></tr>
                        @endif
                        @if ($bug->project)
                    ...
                    @if ($bug->description)
                        <p style="margin:0 0 6px;font-size:13px;color:#6b7280;">Détail :</p>
